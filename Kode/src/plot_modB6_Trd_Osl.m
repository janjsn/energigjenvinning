...
em_hp_nor_ns3720_chp_5(1:end) = lca_em_hp_production_gCO2eq_per_kWh +(Trondheim.emission_intensity_nor_ns3720_2019_2075_gCO2eq_per_kWh)/5;
em_hp_eu_ns3720_chp_5(1:end) = lca_em_hp_production_gCO2eq_per_kWh +(Trondheim.emission_intensity_eu28_nor_ns3720_2019_2075_gCO2eq_per_kWh)/5;
...
em_hp_Swe_chp_5(1:length(B_cont)) = lca_em_hp_production_gCO2eq_per_kWh+Gothenborg.emission_intensity_norwegian_electricity_gCO2eq_per_kWh*1.3/5;
